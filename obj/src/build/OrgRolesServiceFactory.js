...
const OrgRolesHttpServiceV1_1 = require("../services/version1/OrgRolesHttpServiceV1");
...
class OrgRolesServiceFactory extends pip_services3_components_nodex_1.Factory {
    constructor() {
        ...
        this.registerAsType(OrgRolesServiceFactory.HttpServiceDescriptor, OrgRolesHttpServiceV1_1.OrgRolesHttpServiceV1);
...
OrgRolesServiceFactory.HttpServiceDescriptor = new pip_services3_commons_nodex_1.Descriptor("service-orgroles", "service", "http", "*", "1.0");
